...
export async function GET(request: Request) {
  return observeSenaApiRoute(request, { routeId: "sena-ops-identity-production-evidence" }, async () => {
    ...
    const evidence = await getEnterpriseIdentityProductionEvidenceWithPostgresEvidence({ teamId });
