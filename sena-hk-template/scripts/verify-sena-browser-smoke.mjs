...
async function verifyArtifactDownloadsAndRestore(page) {
  ...
  assertTextIncludes(reportJson.runtimeProvenance?.enaRuntime?.dependencySpec ?? "", "0.6.2", "report JSON jENA provenance");
  ...
  assertArrayIncludes(
    ...
    "runtimeEvidence=sena-jena-manifest.json|sena-ena-report.json|sena-jsna-manifest.json|sena-runtime-consistency-audit.json|jena-api-surface|jsna-api-surface|jena-rena-parity|jsna-r-sna-parity|matrix-fingerprints|0.6.2|npm:@peterhudongpin/sna.js@0.4.0",
